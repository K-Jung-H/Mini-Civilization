...
namespace MiniCivilization.World.Tests
{
    public sealed class SurfaceHeightResolverTests
    {
        ...
        public void CornerHeight_ConcaveDropRaisesOnlyTheLowCellCorner()
        {
            ...
            world.SetColumnSolidHeightUnits(0, 0, 5);
            world.SetColumnSolidHeightUnits(1, 0, 5);
            world.SetColumnSolidHeightUnits(0, 1, 5);
            world.SetColumnSolidHeightUnits(1, 1, 1);
        ...
        {
            var world = new WorldData(4, 4, 2, 2, 2, 1);
            world.SetColumnSolidHeightUnits(0, 0, 3);
            world.SetColumnSolidHeightUnits(1, 0, 6);
            world.SetColumnSolidHeightUnits(0, 1, 5);
            world.SetColumnSolidHeightUnits(1, 1, 1);
        ...
        {
            var world = new WorldData(4, 4, 2, 2, 2, 1);
            world.SetColumnSolidHeightUnits(0, 0, 1);
            world.SetColumnSolidHeightUnits(1, 0, 5);
            world.SetColumnSolidHeightUnits(0, 1, 5);
            world.SetColumnSolidHeightUnits(1, 1, 1);
